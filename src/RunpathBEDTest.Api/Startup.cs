...
namespace RunpathBEDTest
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<PhotoAlbumConfig>(Configuration.GetSection("PhotoAlbumConfig"));

            services.AddTransient<IHttpClientWrapper, HttpClientWrapper>();
            services.AddTransient<IPhotoAlbumRepo, PhotoAlbumRepo>();
